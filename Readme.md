...
### 20170510
>데이터베이스에서 유니크 값으로 겪던 문제를 해결함 (이전 업데이트 햇던거 보다 좀더 자세한 수정)

### 20170402
>공지를 새로 만들때 공지 종류를 제대로 입력하지 않앗을 때 디폴트 값이 제대로 입력 되지 않는 문제를 수정함.

### 20170313
>정보 변경 날짜를 추가로 리턴해 주는 것으로 변경

### 20170308
>클라이언트의 요구 대로 지정해주는 날짜 기준으로 그 날짜보다 최신인 날짜만 클라이언트에 되돌려준다.

### 20170306
>데이터베이스 모델링에서 발생한 문제들 픽스

### 20170305-1
>데이터베이스 연동 메소드에 접근을 못하는 버그 픽스

### 20170305
>서버 데이터베이스 모델링 문제점 보완
